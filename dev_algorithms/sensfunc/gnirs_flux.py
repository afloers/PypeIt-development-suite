...
#flux_tell(std_path, stdfile, instrument=instrument, sens_polyorder=6,
...
#flux_tell(std_path, stdfile, instrument=instrument, sens_polyorder=6, star_type='A0',star_mag=6.523,
#          do_sens=True, do_flux=False, do_stack=False, do_tell=False, disp=True, debug=True)
stdfile = 'spec1d_N20190531S0067-HIP56736_GNIRS_2019May31T073323.707.fits'
#flux_tell(std_path, stdfile, instrument=instrument, sens_polyorder=6, star_type='A0',star_mag=8.78,
#          do_sens=True, do_flux=False, do_stack=False, do_tell=False, disp=True, debug=True)
